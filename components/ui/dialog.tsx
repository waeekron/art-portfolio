...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "in-from-top animate-entrance   grid h-screen  w-screen max-w-lg gap-4 border bg-background py-0 shadow-lg transition-all duration-500 sm:rounded-lg md:pl-3",
        className,
      )}
      {...props}
    >
